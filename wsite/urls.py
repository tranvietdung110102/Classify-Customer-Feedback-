...
urlpatterns = [
    ...
    path('classify-dashboard', views.dashboard_classify, name="classify.dashboard"),
    path('pie-chart', views.pie_chart),
    path('bar-chart', views.bar_chart),
    path('bar-chart-day', views.get_daily_classifications),
